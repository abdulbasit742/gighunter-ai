...
app.get('/', (_req, res) => res.json({
  ...
  dashboard: '/app',
  endpoints: ['/health', 'POST /hunt', '/gigs', '/gigs/:id', 'POST /gigs/:id/status', 'POST /gigs/:id/proposal', '/proposals/:id', '/api/platforms', '/api/doctor'],
}));
...
if (process.env.NODE_ENV !== 'test') {
  ...
  // Optional built-in daily auto-hunt. Enable with SCHEDULE_HUNT=true.
